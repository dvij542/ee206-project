...
{
  new (message_memory) lbr_fri_msgs::msg::LBRCommand(_init);
}

void LBRCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lbr_fri_msgs::msg::LBRCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LBRCommand_message_member_array[3] = {
  {
    ...
    offsetof(lbr_fri_msgs::msg::LBRCommand, joint_position),  // bytes offset in struct
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(lbr_fri_msgs::msg::LBRCommand, wrench),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    7,  // array size
    false,  // is upper bound
    offsetof(lbr_fri_msgs::msg::LBRCommand, torque),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LBRCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(lbr_fri_msgs::msg::LBRCommand),
...
get_message_type_support_handle<lbr_fri_msgs::msg::LBRCommand>()
{
  return &::lbr_fri_msgs::msg::rosidl_typesupport_introspection_cpp::LBRCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lbr_fri_msgs, msg, LBRCommand)() {
  return &::lbr_fri_msgs::msg::rosidl_typesupport_introspection_cpp::LBRCommand_message_type_support_handle;
}
