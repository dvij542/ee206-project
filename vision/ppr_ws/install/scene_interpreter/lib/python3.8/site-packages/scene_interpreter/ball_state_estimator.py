...
from .HistoryBallDetector import HistoryBallDetector
...
estimate_ball_3D_spatial_coords = estimate_ball_3D_spatial_coords(detector_obj_type = HistoryBallDetector)