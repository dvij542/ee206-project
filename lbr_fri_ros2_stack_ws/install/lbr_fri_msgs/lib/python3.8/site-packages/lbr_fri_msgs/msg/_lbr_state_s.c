...
bool lbr_fri_msgs__msg__lbr_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lbr_fri_msgs.msg._lbr_state.LBRState", full_classname_dest, 36) == 0);
  }
  lbr_fri_msgs__msg__LBRState * ros_message = _ros_message;
  {  // sample_time
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * lbr_fri_msgs__msg__lbr_state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of LBRState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lbr_fri_msgs.msg._lbr_state");
  ...
  lbr_fri_msgs__msg__LBRState * ros_message = (lbr_fri_msgs__msg__LBRState *)raw_ros_message;
  {  // sample_time
    PyObject * field = NULL;
