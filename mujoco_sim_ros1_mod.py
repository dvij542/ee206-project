...
from mujoco_env_only_kuka_ik import KukaTennisEnv as KukaTennisEnvIK
from stable_baselines3 import PPO
from mujoco_env_kuka_with_table_mod import KukaTennisEnv
# Import Twist
...
# Callback function for ball_info
def ball_callback(msg: Twist):
    """Callback to update the ball state in the environment."""
    ball_pos = np.array([msg.linear.x, msg.linear.y, msg.linear.z])
    ball_vel = np.array([msg.angular.x, msg.angular.y, msg.angular.z])
    env.update_ball_state(ball_pos, ball_vel)
...
if __name__ == '__main__':
    ...
    try:
        ...
        ball_sub = rospy.Subscriber('/ball_info', Twist, ball_callback)
