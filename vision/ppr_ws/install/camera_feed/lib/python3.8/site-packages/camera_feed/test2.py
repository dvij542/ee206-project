...
#    T = np.array([  57.69871518,  -40.55536   , -286.55454885]).reshape((3, 1))
    ...
    return mtx_list, dist_list, P_list, R_list , g_spatial_cam3,P0,P1,P2,P3
...
mtx_list, dist_list, P_list, R_list,g_spatial_cam3,P0,P1,P2,P3 = load_calibration_results("calibration_results.npz")
