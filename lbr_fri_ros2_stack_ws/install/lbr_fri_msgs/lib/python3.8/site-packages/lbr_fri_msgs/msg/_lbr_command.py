...
class Metaclass_LBRCommand(type):
    """Metaclass of message 'LBRCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__lbr_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__lbr_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__lbr_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__lbr_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__lbr_command
...
class LBRCommand(metaclass=Metaclass_LBRCommand):
    """Message class 'LBRCommand'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'torque' not in kwargs:
            self.torque = numpy.zeros(7, dtype=numpy.float64)
        else:
            self.torque = numpy.array(kwargs.get('torque'), dtype=numpy.float64)
            assert self.torque.shape == (7, )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'joint_position' field must be a set or sequence with length 7 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'wrench' field must be a set or sequence with length 6 and each value of type 'float'"
    ...
    def torque(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 7, \
                "The 'torque' numpy.ndarray() must have a size of 7"
            self._torque = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'torque' field must be a set or sequence with length 7 and each value of type 'float'"
