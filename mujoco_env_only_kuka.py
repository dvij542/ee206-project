...
class KukaTennisEnv(gym.Env):
    ...
    def step_from_robot(self, joint_info, t, quat):
        ...
        self.data.qpos[:7] = joint_info[:7]
        # self.data.qvel[:7] = joint_info[7:]
        mj.mj_step(self.model, self.data)
        # self.data.qpos[:7] = joint_info[:7]
        # print(self.data.qpos, joint_info[:7])
        ...
        # print(self.data.body('tennis_racket').xpos-self.data.body('link7').xpos,self.data.body('link7').xquat[[1,2,3,0]])
        ...
        # print(end_effector_pos, end_effector_quat)
